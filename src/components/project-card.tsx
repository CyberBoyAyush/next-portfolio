  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute inset-0 p-[1px] bg-gradient-to-br from-gray-700 via-gray-600 to-gray-700 group-hover:from-blue-500/50 group-hover:via-purple-500/50 group-hover:to-pink-500/50 transition-all duration-300">
        ...
        <div className="relative z-10 flex flex-col h-full p-6">
          ...
          {showFeaturedBadge && project.featured && (
            <div className="absolute top-4 right-4 z-20">
              <div className="relative flex items-center gap-1.5 px-3 py-1 bg-blue-500/20 backdrop-blur-md border border-blue-400/30 shadow-[0_0_15px_-3px_rgba(59,130,246,0.3)]">
          ...
          <div className="flex flex-col flex-1">
              ...
              <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
                {project.demoLink && (
                  <a
                    ...
                    className="p-2 bg-gray-800 hover:bg-gray-700 text-gray-400 hover:text-white border border-gray-700 hover:border-gray-600 transition-all"
            ...
            <div className="mt-auto">
              ...
              <div className="flex flex-wrap gap-1.5 mb-4">
                {project.tags.slice(0, 6).map((tag, idx) => {
                  ...
                  return (
                    <span
                      key={idx}
                      className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-gray-800/80 backdrop-blur-sm text-gray-300 text-xs font-medium border border-gray-700/50 hover:border-gray-600 hover:bg-gray-800 transition-colors"
                    >
                      {icon}
                      {tag}
                    </span>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-3 border-t border-gray-800">
                ...
                <button
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-3 py-1.5 bg-white/5 hover:bg-white/10 text-white text-xs font-medium border border-white/10 hover:border-white/20 transition-all group/btn"
                >
          ...
          {isDialogOpen && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
              ...
              <motion.div
                ...
                className="relative w-full max-w-lg bg-[#0D1117] border border-gray-800 shadow-2xl overflow-hidden z-10"
                onClick={(e) => e.stopPropagation()}
              >
                {/* Close Button */}
                <button
                  onClick={handleCloseDialog}
                  className="absolute top-3 right-3 p-1.5 bg-black/20 hover:bg-white/10 text-gray-400 hover:text-white transition-colors z-20"
                >
                  <X size={18} />
                </button>
                    ...
                    <div className="absolute bottom-5 left-5 right-5">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.tags.slice(0, 3).map((tag) => (
                          <span key={tag} className="text-[10px] font-medium text-gray-300 bg-white/10 px-2 py-0.5 backdrop-blur-sm">
                            {tag}
                          </span>
                        ))}
                      </div>
                  ...
                  <div className="p-5 pt-2">
                    ...
                    <div className="grid gap-2.5">
                      <Link
                        ...
                        className="flex items-center justify-center gap-2 w-full py-2.5 bg-white text-black text-sm font-bold hover:bg-gray-200 transition-colors"
                      >
                        Explore Case Study
                      ...
                      <div className="grid grid-cols-2 gap-2.5">
                        {project.demoLink && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center justify-center gap-2 py-2 bg-[#161B22] text-white text-xs font-medium border border-gray-700 hover:border-gray-600 hover:bg-[#1C2128] transition-all"
                          >
                            <Globe2 size={14} />
                            Live Demo
                          </a>
