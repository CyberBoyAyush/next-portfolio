      ...
      <div className="min-h-screen bg-[#0D1117] flex items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center relative z-10">
          ...
          <button
            ...
            className="px-6 py-3 bg-white text-black font-semibold rounded-xl hover:bg-gray-200 transition-colors flex items-center gap-2 mx-auto"
          >
    ...
    <div className="min-h-screen bg-[#0D1117] pb-20 relative overflow-x-hidden" ref={containerRef}>
      ...
      <div className="container mx-auto px-4 md:px-6 pt-24 md:pt-32 max-w-7xl">
        ...
        >
          <button
            onClick={() => router.push('/projects')}
            className="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors px-4 py-2 rounded-full hover:bg-white/5 border border-transparent hover:border-white/10"
          >
          ...
          <div className="flex gap-2">
             {prevProject && (
                <Link 
                   ...
                   className="w-10 h-10 flex items-center justify-center rounded-full border border-white/10 bg-white/5 text-gray-400 hover:text-white hover:bg-white/10 transition-all"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            <div className="flex flex-wrap gap-3 mb-6">
              {project.isHackathonProject && (
                <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-orange-500/10 text-orange-400 rounded-full text-xs font-medium border border-orange-500/20">
              ...
              <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-purple-500/10 text-purple-400 rounded-full text-xs font-medium border border-purple-500/20">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
              {project.demoLink && (
                <a
                  ...
                  className="group relative w-full sm:w-auto flex justify-center items-center gap-2 px-6 py-3 md:px-8 md:py-4 bg-white text-black font-bold rounded-xl md:rounded-2xl overflow-hidden hover:scale-[1.02] transition-all shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] text-sm md:text-base"
                >
              ...
              {project.githubLink && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-full sm:w-auto flex justify-center items-center gap-2 px-6 py-3 md:px-8 md:py-4 bg-[#161B22] text-white font-bold rounded-xl md:rounded-2xl border border-gray-700/50 hover:border-gray-600 hover:bg-[#1C2128] transition-all hover:scale-[1.02] text-sm md:text-base"
                >
          ...
          >
            {/* Glow behind image */}
            <div className={`absolute -inset-4 bg-gradient-to-r ${project.color} opacity-20 blur-2xl rounded-[32px] -z-10`} />
            
            <div className="rounded-2xl bg-[#1C1C1C] border border-gray-800 shadow-2xl overflow-hidden">
              {/* Browser Header */}
              <div className="h-10 bg-[#2A2A2A] flex items-center px-4 gap-2 border-b border-gray-800">
                ...
                <div className="flex-1 mx-4">
                  <div className="h-6 bg-[#1C1C1C] rounded-md flex items-center justify-center text-[10px] text-gray-500 font-mono">
        ...
        <div className="grid lg:grid-cols-3 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            >
              <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
                <span className={`w-1.5 h-8 rounded-full bg-gradient-to-b ${project.color}`} />
                Project Overview
              </h2>
          ...
          <div className="space-y-8">
             ...
             >
                {/* Tech Stack Card */}
                <div className="rounded-3xl bg-[#161B22]/80 backdrop-blur-xl border border-white/10 p-8 shadow-xl mb-8">
                   ...
                   <div className="flex flex-wrap gap-2">
                      {project.tags.map((tech) => (
                         <div 
                            key={tech} 
                            className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 border border-white/5 hover:bg-white/10 hover:border-white/10 transition-all cursor-default group"
                         >
                ...
                {/* Project Status Card */}
                <div className="rounded-3xl bg-gradient-to-br from-[#161B22]/80 to-[#0D1117]/80 backdrop-blur-xl border border-white/10 p-8 shadow-xl">
                   <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-2">
        ...
        {nextProject && (
           ...
           >
              ...
              <Link href={`/projects/${nextProject.slug}`} className="block group">
                 <div className="relative rounded-3xl overflow-hidden aspect-[21/9] md:aspect-[3/1] border border-white/10 bg-[#161B22]">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-6">
                       ...
                       <div className="mt-8 w-12 h-12 rounded-full bg-white text-black flex items-center justify-center transform scale-0 group-hover:scale-100 transition-all duration-300 delay-100">
