    ...
    <main className="min-h-screen bg-[#0D1117] pt-20 md:pt-20">
      <section ref={sectionRef} className="py-8 md:py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          >
            <div className="inline-flex items-center gap-2 px-6 py-3 md:px-8 md:py-4 bg-gradient-to-r from-gray-800/60 to-gray-700/60 border border-gray-600/30 backdrop-blur-sm">
